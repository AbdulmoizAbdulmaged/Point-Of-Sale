        ...
        Try
            If MaskedTextBox6.Text <> "" Then
                If MaskedTextBox6.Text.Length = 5 Then
                    ...
                    conn_string = "Data Source=" + MaskedTextBox3.Text + ":1521/orcl;User Id=" + MaskedTextBox1.Text + ";password=" + MaskedTextBox2.Text + ";"
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        Try
            If RadioButton1.Checked = True Then
                ...
                End If
                My.Computer.FileSystem.CopyFile("System_Config.cap", "C:\POS\System Administrator.exe", Microsoft.VisualBasic.FileIO.UIOption.AllDialogs, Microsoft.VisualBasic.FileIO.UICancelOption.DoNothing)
                My.Computer.FileSystem.CopyFile("POS.cap", "C:\POS\POS Screen.exe", Microsoft.VisualBasic.FileIO.UIOption.AllDialogs, Microsoft.VisualBasic.FileIO.UICancelOption.DoNothing)
                ...
                MyShortcut = CType(WshShell.CreateShortcut(DesktopFolder & "\System Administrator.lnk"), IWshRuntimeLibrary.IWshShortcut)

                MyShortcut.TargetPath = "C:\POS\System Administrator.exe" 'Specify target app full path
                ...
                MyShortcut = CType(WshShell.CreateShortcut(DesktopFolder1 & "\POS Screen.lnk"), IWshRuntimeLibrary.IWshShortcut)

                MyShortcut.TargetPath = "C:\POS\POS Screen.exe" 'Specify target app full path

                MyShortcut.Save()

                Dim DesktopFolder2 As String = Environment.GetFolderPath(Environment.SpecialFolder.Programs)

                MyShortcut = CType(WshShell.CreateShortcut(DesktopFolder2 & "\POS Screen.lnk"), IWshRuntimeLibrary.IWshShortcut)
