...
Public Class stock_by_receipt
    Private Sub stock_by_receipt_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            paramters.Add(New ReportParameter("total", report_manager.total))
